...
class AuthLoginTests(TestCase):
    def test_staff_login_with_email_redirects_to_admin_panel(self):
        ...
        response = self.client.post(
            reverse('login_proses'),
            {'email': 'staff@example.com', 'password': 'staffpass', 'login_as_admin': '1'},
        )
...
class AdminDatasetViewsTests(TestCase):
    def setUp(self):
